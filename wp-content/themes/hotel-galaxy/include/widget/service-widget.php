	...
	public function widget( $args , $instance ) {
		...
		<div class="col-md-4 col-sm-6 animate zoomIn" data-anim-type="zoomIn" data-anim-delay="200">
			<div class="feature-col service-item">
				...
				if( $instance['icon']!=''){
					?>
					<a class="sr-icon" href="<?php echo esc_url( $instance['btn_url'] ); ?>"><i class="fa <?php echo esc_attr( $instance['icon'] ); ?>" style="color:<?php echo esc_attr($instance['icon_color']!='') ? $instance['icon_color'] : '#dbb26b' ?>"></i></a>
					<?php
				}
				?>
