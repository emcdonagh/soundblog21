...
add_action('admin_menu', 'hotel_galaxy_ourproduct');

function hotel_galaxy_ourproduct() {
	$page_product=add_theme_page('Hotel Galaxy Products', 'Our Products', 'edit_theme_options', 'hotel-galaxy-products', 'hotel_galaxy_ourProduct_page');
	add_action('admin_print_styles-'.$page_product, 'hotel_galaxy_admin_info');
}


function hotel_galaxy_ourProduct_page(){

	require_once( get_template_directory() . '/include/admin/our_product.php' );
}
?>